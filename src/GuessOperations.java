...
public final class GuessOperations {
    static boolean GuessAndCheck(BoardPiece[][] possibleNumberBoard, int[][] board, int recursions){
        ...
        List<int[]> coordinatesForGuessing;
        ...
        System.out.println(numbersToGuess.get(1).length);
        System.out.println("lsdfj: " +coordinatesForGuessing.get(1)[0]+","+coordinatesForGuessing.get(1)[1]);
        //System.out.println(indexOfArrayToCheck);

        System.out.println("Guessing on: " +coordinatesForGuessing.get(indexOfArrayToCheck)[0]+","+coordinatesForGuessing.get(indexOfArrayToCheck)[1]);
